...
r = 150.0 / image.shape[1] # get ratio, like 3/4
...
# interpolation is a list of how to choose, when incrementing/decrementing...
# image, how to choose how the new pixel will be. what values to take ...
# reference of. easier for small->large than large->small. as from small->large
#   are creating new pixels that didnt existed before
methods = [
